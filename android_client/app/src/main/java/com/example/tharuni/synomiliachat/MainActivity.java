...
//import com.example.tharuni.synomiliachat.FragContent.UserFragContent;
//import com.example.tharuni.synomiliachat.Fragments.UsersFragment;
...
public class MainActivity extends AppCompatActivity implements UsersFragment.OnListFragmentInteractionListener,ChatFragment.OnListFragmentInteractionListener,FriendsFragment.OnListFragmentInteractionListener {
    ...
    @Override
    public void onListFragmentInteraction(UserFragContent.User item) {

    }

    @Override
    public void onListFragmentInteraction(ChatFragContent.Chat item) {

    }

    @Override
    public void onListFragmentInteraction(FriendFragContent.Friend item) {
