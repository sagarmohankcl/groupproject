...
import com.example.tharuni.synomiliachat.Fragments.FriendsFragment.OnListFragmentInteractionListener;
import com.example.tharuni.synomiliachat.FragContent.FriendFragContent.Friend;
...
public class MyFriendsRecyclerViewAdapter extends RecyclerView.Adapter<MyFriendsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyFriendsRecyclerViewAdapter(List<Friend> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
